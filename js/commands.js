var twitter = "";
var linkedin = "https://www.linkedin.com/in/adam-hall-35297a254/";
var instagram = "";
var github = "https://github.com/ah682";
var hackerrank = "";
var sudo = "";
var email = "mailto:adamhall929@gmail.com";

aboutme = [
  "<br>",
  "<span class='underline'>I'm Adam.</span>",
  "<br>",
  "<li>🔭 I’m currently a student at the University of Central Lanashire</li>",
  ...
  `<li><pre class="whitespace-pre-wrap">👯 I would love to work with anyone who wants to build a 
   ...
   I use languages such as C++, Python, React and Tailwind CSS when building my 
   projects.
  ...
  `<li><pre class="whitespace-pre-wrap">👨‍💻 Check my github profile to view my projects
   *Use the github command to take a look at my GitHub profile.`,
  `<li>📫 Contact me at <a href= "mailto:adamhall929@gmail.com" target="_blank">adamhall929@gmail.com</a>`,
  "<br>",
];
